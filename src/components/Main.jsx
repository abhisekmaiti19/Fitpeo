  ...
  return (
    <div>
      ...
      <section id="status">
        ...
        <div id="card">
          <i class="fi fi-rr-badge-dollar" id="emni"></i>
          <div class="carddetails">
            <span id="tname">Earning</span>
            <span id="value">$198K</span>
            <span id="gainloss"
              ><i class="fi fi-rr-arrow-trend-up">37.8%</i>this month</span
            >
          </div>
        </div>
      
        <div id="card">
          <i class="fi fi-rr-receipt" id="emni"></i>
          <div class="carddetails">
            <span id="tname">Earning</span>
            <span id="value">$198K</span>
            <span id="gainloss"
        ...
        <div id="card">
          <i class="fi fi-rr-coins" id="emni"></i>
          <div class="carddetails">
            <span id="tname">Earning</span>
            <span id="value">$198K</span>
            <span id="gainloss"
              ><i class="fi fi-rr-arrow-trend-down">37.8%</i>this month</span
            >
          </div>
        </div>
        <div id="card">
          <i class="fi fi-rr-shopping-bag" id="emni"></i>
          <div class="carddetails">
            <span id="tname">Earning</span>
            <span id="value">$198K</span>
            <span id="gainloss"
      ...
      <section id="others">
        <section id="progress">
          ...
          <div id="overview">
            ...
            <div id="overtitle">
              <span id="over">Overview <span>Monthly Earning</span></span>
              <select name="Queterly" id="qtr">
        ...
        <section id="tablehold">
          <section id="table">
       
            <div id="tablenav">
              <span id="Prdsell">Product Sell</span>
              <div id="datasrch">
                <div id="searchbox">
                  <i class="fi fi-rr-search"></i>
                  <input type="text" name="" placeholder="Search" id="" />
            ...
            <div id="desclist">
              ...
              <div id="singledata">
                ...
                <ul id="descall">
                  <li id="stock">32 in stocks</li>
                  <li id="price">$ 45.99</li>
                  <li id="totalsales">20</li>
                </ul>
              </div>
